  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        aria-describedby={ariaDescribedBy}
        className={cn(
          'bg-main-view max-h-[calc(100vh-4rem)] overflow-auto border-main-view-fg/10 text-main-view-fg data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100vw-2rem)] translate-x-[-50%] translate-y-[-50%] gap-6 rounded-xl border p-8 shadow-xl duration-300 sm:max-w-lg backdrop-blur-sm',
          className
        )}
        {...props}
      >
