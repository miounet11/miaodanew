...
import { getMiaodaDataFolderPath, joinPath, fs } from '@miaoda/core'
...
export const ModelSupportStatus = ({
  ...
  const checkModelSupportWithPath = useCallback(
    async (
      ...
      try {
        const miaodaDataFolder = await getMiaodaDataFolderPath()
        ...
        const actualModelPath =
          ...
          modelConfig.model_path.match(/^[A-Za-z]:/)
            ...
            : await joinPath([miaodaDataFolder, modelConfig.model_path]) // relative path, join with data folder
