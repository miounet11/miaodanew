...
function General() {
  ...
  const [miaodaDataFolder, setMiaodaDataFolder] = useState<string | undefined>()
  ...
  useEffect(() => {
    const fetchDataFolder = async () => {
      const path = await serviceHub.app().getMiaodaDataFolder()
      setMiaodaDataFolder(path)
    }
  ...
  const handleDataFolderChange = async () => {
    const selectedPath = await serviceHub.dialog().open({
      multiple: false,
      directory: true,
      defaultPath: miaodaDataFolder,
    })

    if (selectedPath === miaodaDataFolder) return
  ...
  const confirmDataFolderChange = async () => {
    if (selectedNewPath) {
      try {
        ...
        setTimeout(async () => {
          try {
            await serviceHub.app().relocateMiaodaDataFolder(selectedNewPath)
            setMiaodaDataFolder(selectedNewPath)
        ...
        const originalPath = await serviceHub.app().getMiaodaDataFolder()
        setMiaodaDataFolder(originalPath)
          ...
          <div className="flex flex-col justify-between gap-4 gap-y-3 w-full">
                ...
                description={
                  <>
                    ...
                    <div className="flex items-center gap-2 mt-1 ">
                      ...
                      <button
                        onClick={() =>
                          miaodaDataFolder && copyToClipboard(miaodaDataFolder)
                        }
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <Button
                      ...
                      onClick={async () => {
                        if (miaodaDataFolder) {
                          try {
                            const logsPath = `${miaodaDataFolder}/logs`
            ...
            <Card title={t('settings:general.resources')}>
              ...
              <CardItem
                ...
                actions={
                  <a
                    href="https://www.miaoda.xin/docs"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <div className="flex items-center gap-1">
              ...
              <CardItem
                ...
                actions={
                  <a
                    href="https://github.com/miounet11/miaoda/releases"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    <div className="flex items-center gap-1">
            ...
            <Card title={t('settings:general.community')}>
              <CardItem
                ...
                actions={
                  <a
                    href="https://github.com/miounet11/miaoda"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
            ...
            <Card title={t('settings:general.support')}>
              <CardItem
                ...
                actions={
                  <a
                    href="https://github.com/miounet11/miaoda/issues/new"
                    target="_blank"
                  >
                    <div className="flex items-center gap-1">
