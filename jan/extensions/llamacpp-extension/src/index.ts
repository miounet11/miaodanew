/**
 * @file This file exports a class that implements the InferenceExtension interface from the @miaoda/core package.
 * The class provides methods for initializing and stopping a model, and for making inference requests.
 * It also subscribes to events emitted by the @miaoda/core package and handles new message requests.
 * @version 1.0.0
...
import {
  GgufMetadata,
  readGgufMetadata,
} from '@miaoda/tauri-plugin-llamacpp-api'
import { getSystemUsage } from '@miaoda/tauri-plugin-hardware-api'
...
/**
 * A class that implements the InferenceExtension interface from the @miaoda/core package.
 * The class provides methods for initializing and stopping a model, and for making inference requests.
 * It also subscribes to events emitted by the @miaoda/core package and handles new message requests.
 */
...
export default class llamacpp_extension extends AIEngine {
  ...
  private async removeOldBackend(
    ...
    try {
      const janDataFolderPath = await getMiaodaDataFolderPath()
