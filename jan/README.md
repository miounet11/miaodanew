...
![Miaoda AI](docs/src/pages/docs/_assets/miaoda-app.png)

<p align="center">
  <!-- ALL-CONTRIBUTORS-BADGE:START - Do not remove or modify this section -->
  <img alt="GitHub commit activity" src="https://img.shields.io/github/commit-activity/m/miounet11/miaoda"/>
  <img alt="Github Last Commit" src="https://img.shields.io/github/last-commit/miounet11/miaoda"/>
  <img alt="Github Contributors" src="https://img.shields.io/github/contributors/miounet11/miaoda"/>
  <img alt="GitHub closed issues" src="https://img.shields.io/github/issues-closed/miounet11/miaoda"/>
  <img alt="Discord" src="https://img.shields.io/discord/1107178041848909847?label=discord"/>
</p>

<p align="center">
  <a href="https://www.miaoda.xin/docs/quickstart">快速开始</a>
  - <a href="https://www.miaoda.xin/docs">文档</a>
  - <a href="https://www.miaoda.xin/changelog">更新日志</a>
  - <a href="https://github.com/miounet11/miaoda/issues">问题反馈</a>
  - <a href="https://discord.gg/AsJ8krTT3N">Discord</a>
</p>

妙答是一个可以在您的设备上100%离线运行的AI助手。下载并运行大语言模型，拥有
**完全控制权** 和 **隐私保护**。
