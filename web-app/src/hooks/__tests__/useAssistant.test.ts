...
describe('useAssistant', () => {
  ...
  it('should update assistant', () => {
    ...
    expect(result.current.assistants[0].name).toBe('Updated Miaoda')
  ...
  it('should maintain assistant structure', () => {
    ...
    expect(result.current.currentAssistant.name).toBe('Miaoda')
  ...
  it('should update assistant in current assistant if it matches', () => {
    ...
    expect(result.current.currentAssistant.name).toBe('Updated Miaoda Name')
  })
})
