...
if [ "${RELEASE_CHANNEL}" != "stable" ]; then
    APP_DIR=./src-tauri/target/release/bundle/appimage/Miaoda-${RELEASE_CHANNEL}.AppDir
    LIB_DIR=$APP_DIR/usr/lib/Miaoda-${RELEASE_CHANNEL}/binaries
else
    APP_DIR=./src-tauri/target/release/bundle/appimage/Miaoda.AppDir
    LIB_DIR=$APP_DIR/usr/lib/Miaoda/binaries
fi
