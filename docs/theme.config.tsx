...
const defaultUrl = 'https://www.miaoda.xin'
const defaultImage = 'https://www.miaoda.xin/assets/images/general/og-image.png'
...
const config: DocsThemeConfig = {
  logo: (
    <span className="flex gap-x-8 items-center">
      <div className="flex">
        <LogoMark />
        <span className="ml-2 text-lg font-semibold">Miaoda</span>
      </div>
    </span>
  ),
  docsRepositoryBase: 'https://github.com/miounet11/miaoda/tree/main/docs',
  feedback: {
  ...
  navbar: {
    extraContent: (
      <div className="inline-flex items-center gap-x-2">
        ...
        <a href="https://github.com/miounet11/miaoda" target="_blank">
