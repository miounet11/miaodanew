...
// Mock EngineManager
vi.mock('@miaoda/core', async (importOriginal) => {
...
describe('TauriAppService', () => {
  ...
  describe('getMiaodaDataFolder', () => {
    it('should get jan data folder path', async () => {
      ...
      const result = await appService.getMiaodaDataFolder()
  ...
  describe('relocateMiaodaDataFolder', () => {
    it('should relocate jan data folder', async () => {
      ...
      await appService.relocateMiaodaDataFolder(newPath)
